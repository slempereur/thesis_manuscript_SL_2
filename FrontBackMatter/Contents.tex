...
\acro{HCS}{Crible haut-débit (de l'anglais high content screening)}
\acro{HTI}{Imagerie haut-débit (de l'anglais high troughput imaging)}
\acro{HCA}{Analyse haut-débit (de l'anglais high content analysis)}
\acro{RI}{indice de réfraction (de l'anglais refractive index)}
\acro{ZFaCT}{}
