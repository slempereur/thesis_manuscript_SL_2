...
\newcommand{\myTitle}{
    Analyse morphométrique du cerveau du \pz{}:
    }
\newcommand{\mySubtitle}{
    \textsc{Mise en place de procédures d'imagerie et de segmentations rapides}\xspace
    }
...
\newcommand{\myLocation}{Laboratoire d'informatique Gaspard Monge\xspace}
